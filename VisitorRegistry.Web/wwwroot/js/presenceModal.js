$(document).ready(function () {
    ...
    function renderModalContent(data, editMode) {
        ...
        let checkInValue = toLocalDateTimeString(data.checkInTime);
        let checkOutValue = toLocalDateTimeString(data.checkOutTime);
        ...
        if (!editMode) {
            ...
            <p><strong>Check-in:</strong> ${data.checkInTime
                    ? new Date(data.checkInTime).toLocaleString('it-IT', {
                        day: '2-digit',
                        month: '2-digit',
                        year: 'numeric',
                        hour: '2-digit',
            ...
            <p><strong>Check-out:</strong> ${data.checkOutTime
                    ? new Date(data.checkOutTime).toLocaleString('it-IT', {
                        day: '2-digit',
                        month: '2-digit',
                        year: 'numeric',
                        hour: '2-digit',
